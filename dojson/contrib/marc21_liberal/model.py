...
marc21_liberal_authority = Overdo(
    entry_point_group='dojson.contrib.marc21_liberal_authority',
    exception_handlers={MissingRule: marc21_liberal_handler})
...
marc21_liberal_holdings = Overdo(
    entry_point_group='dojson.contrib.marc21_liberal_holdings',
    exception_handlers={MissingRule: marc21_liberal_handler})
