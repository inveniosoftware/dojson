...
@marc21_liberal.over('control_number', '^001')
def control_number(self, key, value):
    """Control Number."""
    return value


@marc21_liberal.over('control_number_identifier', '^003')
def control_number_identifier(self, key, value):
    """Control Number Identifier."""
    return value


@marc21_liberal.over('date_and_time_of_latest_transaction', '^005')
def date_and_time_of_latest_transaction(self, key, value):
    """Date and Time of Latest Transaction."""
    return value


@marc21_liberal.over('fixed_length_data_elements_additional_material_characteristics', '^006')
...
@marc21_liberal.over('physical_description_fixed_field_general_information', '^007')
...
@marc21_liberal.over('fixed_length_data_elements', '^008')
