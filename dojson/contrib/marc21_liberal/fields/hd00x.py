...
@marc21_liberal_holdings.over('control_number', '^001')
def control_number(self, key, value):
    """Control Number."""
    return value


@marc21_liberal_holdings.over('control_number_identifier', '^003')
def control_number_identifier(self, key, value):
    """Control Number Identifier."""
    return value


@marc21_liberal_holdings.over('date_and_time_of_latest_transaction', '^005')
