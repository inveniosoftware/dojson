...
@marc21.over('series_added_entry_personal_name', '^800[301_].')
...
@marc21.over('series_added_entry_corporate_name', '^810[01_2].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('series_added_entry_meeting_name', '^811[01_2].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('series_added_entry_uniform_title', '^830.[4307_258196]')
@utils.for_each_value
@utils.filter_values
