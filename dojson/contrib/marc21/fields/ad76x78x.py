...
@marc21_authority.over('established_heading_linking_entry_medium_of_performance_term', '^762.[473620_15]')
...
@marc21_authority.over('subdivision_linking_entry_general_subdivision', '^780.[473620_15]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('subdivision_linking_entry_geographic_subdivision', '^781.[473620_15]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('subdivision_linking_entry_chronological_subdivision', '^782.[473620_15]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('subdivision_linking_entry_form_subdivision', '^785.[473620_15]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('complex_linking_entry_data', '^788.[473620_15]')
@utils.filter_values
