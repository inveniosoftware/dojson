...
@marc21.over('location', '^852[713548_602][021_]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('electronic_location_and_access', '^856[34_7210][8_021]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('machine_generated_metadata_provenance', '^883[01_].')
@utils.for_each_value
@utils.filter_values
