...
@marc21.over('copyright_or_legal_deposit_number', '^017.[_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('international_standard_serial_number', '^022[1_0].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('other_standard_identifier', '^024[8271_304][1_0]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('publisher_number', '^028[251_304][1_302]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('date_time_and_place_of_an_event', '^033[1_02][1_02]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('coded_cartographic_mathematical_data', '^034[1_30][1_0]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('source_of_acquisition', '^037[_32].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('language_code', '^041[1_0][7_]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('time_period_of_content', '^045[1_02].')
@utils.filter_values
...
@marc21.over('library_of_congress_call_number', '^050[1_0][_04]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('classification_numbers_assigned_in_canada', '^055[1_0][826519_0473]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('national_library_of_medicine_call_number', '^060[1_0][_04]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('national_agricultural_library_call_number', '^070[1_0].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('subject_category_code', '^072.[7_0]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('universal_decimal_classification_number', '^080[1_0].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('dewey_decimal_classification_number', '^082[71_0][_04]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('additional_dewey_decimal_classification_number', '^083[71_0].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('government_document_classification_number', '^086[1_0].')
@utils.for_each_value
@utils.filter_values
