...
@marc21.over('main_series_entry', '^760[1_0][_8]')
...
@marc21.over('subseries_entry', '^762[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('original_language_entry', '^765[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('translation_entry', '^767[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('supplement_special_issue_entry', '^770[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('supplement_parent_entry', '^772[1_0][_08]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('host_item_entry', '^773[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('constituent_unit_entry', '^774[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('other_edition_entry', '^775[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('additional_physical_form_entry', '^776[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('issued_with_entry', '^777[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('preceding_entry', '^780[1_0][32015467_]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('succeeding_entry', '^785[1_0][32015467_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('data_source_entry', '^786[1_0][_8]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('other_relationship_entry', '^787[1_0][_8]')
@utils.for_each_value
@utils.filter_values
