...
@marc21.over('added_entry_personal_name', '^700[10_3][2_]')
...
@marc21.over('added_entry_corporate_name', '^710[102_][2_]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('added_entry_meeting_name', '^711[102_][2_]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('added_entry_uncontrolled_name', '^720[12_].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('added_entry_uniform_title', '^730[02539817_64][2_]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('added_entry_uncontrolled_related_analytical_title', '^740[20539817_64][2_]')
@utils.for_each_value
@utils.filter_values
