...
@marc21_authority.over('series_dates_of_publication_and_or_sequential_designation', '^640[_10].')
...
@marc21_authority.over('title_related_to_the_entity', '^672.[7196248_530]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('title_not_related_to_the_entity', '^673.[7196248_530]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('biographical_or_historical_data', '^678[_10].')
@utils.for_each_value
@utils.filter_values
