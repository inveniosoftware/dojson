...
@marc21_authority.over('other_standard_identifier', '^024[87_].')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('time_period_of_heading', '^045[120_].')
@utils.filter_values
...
@marc21_authority.over('library_of_congress_call_number', '^050.[40_]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('geographic_classification', '^052[1_7].')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('lc_classification_number', '^053.[40_]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('library_and_archives_canada_call_number', '^055.[40_]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('national_library_of_medicine_call_number', '^060.[40_]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('subject_category_code', '^072.[0_7]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('universal_decimal_classification_number', '^080[10_].')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('dewey_decimal_call_number', '^082[107_][40_]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('dewey_decimal_classification_number', '^083[107_][40_]')
@utils.for_each_value
@utils.filter_values
