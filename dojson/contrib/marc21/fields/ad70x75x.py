...
@marc21_authority.over('established_heading_linking_entry_personal_name', '^700[1_30][51042_376]')
...
@marc21_authority.over('established_heading_linking_entry_corporate_name', '^710[1_02][51042_376]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('established_heading_linking_entry_meeting_name', '^711[1_02][51042_376]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('established_heading_linking_entry_uniform_title', '^730.[51042_376]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('established_heading_linking_entry_chronological_term', '^748.[51042_376]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('established_heading_linking_entry_topical_term', '^750.[51042_376]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('established_heading_linking_entry_geographic_name', '^751.[51042_376]')
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over('established_heading_linking_entry_genre_form_term', '^755.[51042_376]')
@utils.for_each_value
@utils.filter_values
