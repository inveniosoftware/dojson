...
@marc21.over('subject_added_entry_personal_name', '^600[103_][154_20673]')
...
@marc21.over('subject_added_entry_corporate_name', '^610[102_][154_20673]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('subject_added_entry_meeting_name', '^611[102_][154_20673]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('subject_added_entry_uniform_title', '^630[18543_90672][154_20673]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('subject_added_entry_chronological_term', '^648.[154_20673]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('subject_added_entry_topical_term', '^650[102_][154_20673]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('subject_added_entry_geographic_name', '^651.[154_20673]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('index_term_uncontrolled', '^653[102_][154_2063]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('subject_added_entry_faceted_topical_terms', '^654[102_].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('index_term_genre_form', '^655[0_][154_20673]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('index_term_occupation', '^656.[7_]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('index_term_function', '^657.[7_]')
@utils.for_each_value
@utils.filter_values
