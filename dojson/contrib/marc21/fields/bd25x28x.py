...
@marc21.over('publication_distribution_imprint', '^260[_32].')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('production_publication_distribution_manufacture_and_copyright_notice', '^264[_32][_14032]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('address', '^270[_12][70_]')
@utils.for_each_value
@utils.filter_values
