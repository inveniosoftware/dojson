...
@marc21.over('series_statement_added_entry_personal_name', '^400[_310][_10]')
...
@marc21.over('series_statement_added_entry_corporate_name', '^410[2_10][_10]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('series_statement_added_entry_meeting_name', '^411[2_10][_10]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('series_statement_added_entry_title', '^440.[73_40291856]')
@utils.for_each_value
@utils.filter_values
...
@marc21.over('series_statement', '^490[_10].')
@utils.for_each_value
@utils.filter_values
