...
@to_marc21_liberal.over('007', '^physical_description_fixed_field_general_information$')
...
@to_marc21_liberal.over('008', '^fixed_length_data_elements$')
