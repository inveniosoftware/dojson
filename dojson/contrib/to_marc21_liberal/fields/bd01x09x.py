...
def reverse_language_code(self, key, value):
    ...
    json_dict = {
        ...
        '$ind1': indicator_map1.get(value.get('translation_indication'), value.get('translation_indication')),
        '$ind2': indicator_map2.get(value.get('source_of_code'), value.get('source_of_code')),
    }
    # FIXME
    extend_liberal_marc(field_map, value, json_dict)
    return json_dict
